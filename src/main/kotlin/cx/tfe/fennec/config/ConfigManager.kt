...
object ConfigManager {
    ...
    fun load(): FennecConfig {
        ...
        return try {
            ...
            val backup = File(configFile.parentFile, "fennec-client.json.bak")
            configFile.copyTo(backup, overwrite = true)
            LOGGER.error("Failed to parse fennec-client.json — backed up to fennec-client.json.bak and loaded defaults instead.", e)
            FennecConfig()
        }
    }
